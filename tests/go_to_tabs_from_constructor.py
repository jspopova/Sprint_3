...
driver.find_element(By.XPATH, "//p[contains(text(),'Конструктор')]").click() #Кликнуть на Конструктор
driver.find_element(By.XPATH, "//span[contains(text(),'Соусы')]").click() #Переход в раздел Соусы
driver.find_element(By.XPATH, "//span[contains(text(),'Булки')]").click() #Переход в раздел Булки
driver.find_element(By.XPATH, "//span[contains(text(),'Начинки')]").click() #Переход в раздел Начинки
driver.quit()
