...
driver.find_element(By.CLASS_NAME, "Auth_link__1fOlj").click() #Кликнуть на Восстановить пароль
driver.find_element(By.XPATH, "//a[contains(text(),'Войти')]").click() #Кликнуть на Войти
